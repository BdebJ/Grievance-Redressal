                ...
                <div class="container-fluid px-4">
                    ...
                    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                        ...
                        <div class="btn-group me-3">
                            <a href="showcsr"><button type="button" class="btn btn-sm btn-outline-primary active"><i class='fa fa-user'></i>All CSR</button></a>
                                    ...
                                    <s:iterator value="csrList">
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="deletecsr.action?pid=<s:property value="pid"/>"><i class="fa fa-archive"></i></a>
                                            </td>
