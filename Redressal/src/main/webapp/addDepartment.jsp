                        ...
                        <div class="card-body">
                            <form action ="addDepartment" method ="post">
                                <div class="form-floating mb-3">
                                    <input class="form-control" id="deptname" type="text" name ="deptname" placeholder="departname" required/>
                                ...
                                <div class="mt-4 mb-0">
                                    <div class="d-grid"><input type = "submit" class="btn btn-primary btn-block" value="Add Department"></div>
                                </div>
                            </form>
                        </div>
                    </div>
