                    ...
                    <thead>
                        ...
                        <tr>
                            <th scope ="col">
                                ...
                                <s:form action="showtech.action" method="post">
                            </tr>
                            <tr>
                                <th scope ="col">
                                    <s:textfield label="Department Id" name="deptid" />
                            </tr>
                            ...
                            <tr>
                                <th scope ="col">
                                    ...
                                    <s:submit cssClass="button-register" value="Show technicians" />
                                </th>
                            </s:form>
                            <s:if test="ctr>0">
