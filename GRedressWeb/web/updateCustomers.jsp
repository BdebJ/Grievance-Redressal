                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <form action ="updatecustomer" method ="post">
                                    ...
                                    <div class="form-floating mb-3">
                                                <input class="form-control" id="userstatus" type="text" name ="userstatus" placeholder="User Status" value='<s:property value="userstatus"/>'/>
                                            ...
                                            <div class="mt-4 mb-0">
                                                <div class="d-grid"><input type = "submit" class="btn btn-primary btn-block" name="submitType" value="Update Customer"></div>
                                            </div>
                                        </form>
                            </div>
                        </div>
